...
public:
  ...
  Uncompressed_Mem(vertex* VV, long nn, long mm, void* ai, void* _inEdges = NULL, void* ptr = NULL, long len = 0)
  : V(VV), n(nn), m(mm), allocatedInplace(ai), inEdges(_inEdges), filePtr(ptr), len(len) { }
